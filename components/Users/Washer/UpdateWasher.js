...
function UpdateWasher({ updateWasherData }) {
    ...
    const [formData, setFormData] = useState({
        ...
        restPeriodTime: updateWasherData
            ? updateWasherData?.restPeriodTime
            : "",
        underEvaluation: updateWasherData
            ? updateWasherData?.underEvaluation
            : "",
