...
function AddWasher({ updateUserInfo }) {
  ...
  const [imageFile, setImageFile] = useState('');
	const [formData, setFormData] = useState({
		...
		activationPeriod: updateUserInfo ? updateUserInfo?.activationPeriod : "",
		restPeriod: updateUserInfo ? updateUserInfo?.restPeriod : "",
		restPeriodTime: updateUserInfo ? updateUserInfo?.restPeriodTime : "",
		underEvaluation: updateUserInfo ? updateUserInfo?.underEvaluation : "",
		...
		<>
			...
			<Modal centered show={show} onHide={handleClose} size="lg">
				...
				<Modal.Body className=''>
               	...
               	{/* Full Name */}
						...
						<Form.Group className="mb-3" controlId="formBasicEmail">
							...
							<Form.Control type="text" placeholder="Enter Your Address" name='address' required onChange={(e) => handelChange(e)} value={address} />
							<Form.Text className="text-muted">
					  ...
					  {/* Phone Number & other phone */}
						...
						<Form.Group className="mb-3" controlId="formBasicEmail">
							...
							<Form.Control type="text" placeholder="Enter Other Mobile Number" name='RelativePhone' required onChange={(e) => handelChange(e)} value={RelativePhone} />
             ...
             {/* Vehicle Type */}
						...
						<Form.Select className="mb-3" aria-label="Default select example" name='activationPeriod' required onChange={(e) => handelChange(e)}  value={activationPeriod}>
						...
						<h6>Rest period</h6>
						<Form.Select className="mb-3" aria-label="Default select example" name='restPeriod' required onChange={(e) => handelChange(e)} value={restPeriod}>
						...
						<h6>Rest Time</h6>
						<Form.Select className="mb-3" aria-label="Default select example" name='restPeriodTime' required onChange={(e) => handelChange(e)} value={restPeriodTime}>
						...
						<Form.Select className="mb-3" aria-label="Default select example" name='underEvaluation' required onChange={(e) => handelChange(e)} value={underEvaluation}>
